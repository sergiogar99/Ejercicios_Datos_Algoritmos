...
void Node::setNeighbours(const set<Node *> &name)
{
    neighbours = name;
}
...
Node *Node::computeDijkstraPath(Node *dest, vector<Node *> &allNodes)
{
...
//{
//    return (abs(data->getName() - n->getData()->getName()) + 1 );
//}
